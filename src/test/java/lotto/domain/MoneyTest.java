...
@DisplayName("Money Test") //테스트 이름 지정
...
public class MoneyTest {
    ...
    void plus_메서드는_Money를_입력받아_합을_반환한다() {
        Money money1 = Money.won(1000L);
        Money money2 = Money.won(1500L);
    ...
    void times_메서드는_곱하는_수를_입력받아_곱을_반환한다(long amount, long times, long result) {
        ...
        assertThat(money.times(times)).isEqualTo(Money.won(result));
    }
    ...
    void divide_메서드는_Money를_입력받아_몫을_반환한다(long amount1, long amount2, double result) {
        Money money1 = Money.won(amount1);
        Money money2 = Money.won(amount2);
    ...
    void calculateRemainder_메서드는_입력받은_수로_나눴을_때의_나머지를_반환한다(
        ...
        assertThat(money1.calculateRemainder(money2)).isEqualTo(Money.won(result));
    }
    ...
    void isGreaterThanOrEqual_메서드는_비교금액_이상의_경우_true_미만의_경우_false를_반환한다(
        ...
        assertThat(money1.isGreaterEqualthan(money2)).isEqualTo(result);
    }
}

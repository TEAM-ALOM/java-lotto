...
public enum ResultLotto {
    ...
    ResultLotto(int count, boolean bonus, int winningAmount, String message) {
        this.count = count;
        this.bonus = bonus;
    ...
    public static ResultLotto valueOf(int count, boolean bonus) {
        for (ResultLotto result : values()) {
